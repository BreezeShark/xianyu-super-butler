...
import { LayoutDashboard, Users, ShoppingBag, CreditCard, Settings, LogOut, Box, Sparkles, MessageSquare, Bell, Bot } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onLogout }) => {
  const menuItems = [
    ...
    { id: 'ai-config', icon: Bot, label: 'AI配置' },
    { id: 'notifications', icon: Bell, label: '通知渠道' },
